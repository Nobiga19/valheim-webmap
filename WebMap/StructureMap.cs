            ...
            foreach (var zdo in all)
            {
                ...
                if (zdo != null)
                {
                    ...
                    if (x >= 0 && y >= 0 && x < size && y < size)
                    {
                        ...
                        if (creator != 0L)
                        {
                            // Vehicles move and have their own live feed at
                            // /vehicles; the classification only keeps them out of
                            // the structure pixels.
                            if (Vehicles.Classify(pref) == Vehicles.Kind.None)
                            {
